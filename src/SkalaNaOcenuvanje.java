...
public class SkalaNaOcenuvanje {
...
System.out.println("Vnesete go brojot na poeni koj gi dobil studentot");
...
if(procent<51) {
	...
	System.out.println("Studentot dobil 6-ka");
}
else if(procent <=70 && procent>=61) {
System.out.println("Studentot dobil 7-ca");
}
else if(procent <=80 && procent>=71) {
System.out.println("Studentot dobil 8-ca");
}
else if (procent <= 90 && procent>= 81) {
System.out.println("Studentot dobil 9-ka");
}
else if (procent<=100 && procent>=91) {
System.out.println ("Studentot dobil 10-ka");
}
}
}
